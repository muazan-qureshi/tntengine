  ...
  <form class="form" action="" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="password" name="cpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required class="form-control" placeholder="Confirm Your Password">
      </div>
      <div class="form-group col-md-6">
        <label for="">Company OR Agency Name</label>
        <input type="text" name="company" required class="form-control" placeholder="Enter Company OR Agency Name">
      </div>
      <div class="form-group col-md-6">
      ...
      <button type="submit" class="btn-block btn btn-primary" name="add_agent">
        Add Agent
      </button>
    </div>
  </form>
