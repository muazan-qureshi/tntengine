...
class tripntour
{
	...
	function insert_agent()
	{
		if(isset($_POST['add_agent']))
		{
			...
			$sql = "INSERT INTO `agents`(`agent_fname`, `agent_uname`, `agent_email`, `agent_phone`, `agent_cnic`, `agent_password`, `agent_fathername`, `agent_gender`, `agent_dob`, `agent_image`, `createBY`, `agent_address`, `agent_location`, `status`) VALUES ('$fname','$uname','$email','$phone','$cnic','$pwd','$fthrname','$gender','$dob','$img_name','$admin','$add','$location','$st')";
			$query = mysqli_query($this->connection(), $sql);
